...
class DynamicSearchAd(Ad):
    ...
    def get_absolute_url(self):
        return "/dynamicsearchads/%i/" % self.id    
...
class LocationExtension(AdExtension):
    ...
    def get_absolute_url(self):
        return "/locationextensions/%i/" % self.id    
...
class BusinessHoursExtension(AdExtension):
    ...
    def get_absolute_url(self):
        return "/businesshoursextensions/%i/" % self.id    
